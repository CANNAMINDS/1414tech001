...
<section class="about" id="about">
        ...
        <div class="about-content section-content">
          ...
          <p class="section-text">
           "Hello there! 1414-TECHNOLOGY brings together freelancers with skills in web design, electrical engineering, branding, graphics, and planning. We love turning challenges into opportunities by crafting unique solutions that combine technology and creativity. Whether solo or in a team, we value curiosity, collaboration, and fresh ideas."
          </p>
        ...
        <ul class="">
           <li>
              <div class="project-content section-content">
                    ...
                    <p class="section-subtitle">Quality Products</p>

                    <h2 class="h3 section-title">Experience Your Journey Of Technology</h2>
      ...
      <li class="col-md-3 mb-3">
        <div class="">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <time class="text-muted small mt-3 d-block" datetime="{{ $product->created_at->format('Y-m-d') }}">
              Stocked Since {{ $product->created_at->format('F j, Y') }}
            </time>
          </div>
           ...
           {{-- <!-- Card Footer Buttons
            <div class="card-footer d-flex justify-content-between mt-auto">
                       <form action="{{ route('cart.add', $product) }}" method="POST">
                        ...
                        <button class="btn btn-outline-secondary btn-sm">Wishlist</button>
                        <button class="btn btn-outline-info btn-sm">Quick View</button>
                    </div> -->--}}
        ...
        <ul class="project-list">
          ...
          <li>
            <div class="project-content section-content">
              ...
              <p class="section-subtitle">Projects Done</p>

              <h2 class="h3 section-title">Our Experience Will Amaze You!</h2>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <div class="card-content">
                ...
                <h4 class="h5 card-title">Lorem Ipsum Dolokg knv\ojx odidh'ih'dfih'f ifijvkjnr 01</h4>
          ...
          <ul class="contact-list">
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="tel:+255627774448" class="contact-info">(+255)6-2777-4448</a>
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="mailto:info@1414-technology.com" class="contact-info">info@1414-technology.com</a>

                <a href="mailto:support@1414-technology.com" class="contact-info">support@1414-technology.com</a>
              </div>
        ...
        <form action="" class="contact-form">
          ...
          <div class="form-wrapper">
            ...
            <div class="input-wrapper">
              ...
              <input type="text" name="name" id="name" required placeholder="e.g MeekNey Bill" class="input-field">
          ...
          <div class="form-wrapper">
            ...
            <div class="input-wrapper">
              ...
              <input type="email" name="email" id="email" required placeholder="e.g meekneybill@gmail.com"
                class="input-field">
...
<div class="input-wrapper">
  ...
  <input type="text" name="home_address" id="home_address" required placeholder="eg. Kalobe, Mbeya Tanzania" class="input-field">
